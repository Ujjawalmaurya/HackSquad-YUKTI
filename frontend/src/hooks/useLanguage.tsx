...
const translations = {
    en: {
        ...
        loadingData: "Loading photos for your field",
        healthLegend: "Health Color Guide",
        optimal: "Very Green",
        moderate: "Needs Help",
        critical: "Sick Plants",
        ...
        resourceUtilization: "Using things well",
        predictiveInsights: "What might happen",
        economicImpact: "Money Impact",
        ...
        processingEngine: "Farm Helper is thinking...",
        liveResults: "Live Field Results",
        uploadPrompt: "Upload a photo to see plant health, bugs, and crop amount.",
    ...
    hi: {
        ...
        loadingData: "आपके खेत की तस्वीरें लोड हो रही हैं",
        healthLegend: "स्वास्थ्य कलर गाइड",
        optimal: "बहुत हरा",
        moderate: "मदद चाहिए",
        critical: "बीमार पौधे",
        ...
        resourceUtilization: "चीजों का सही उपयोग",
        predictiveInsights: "क्या हो सकता है",
        economicImpact: "पैसों पर असर",
        ...
        processingEngine: "फार्म हेल्पर सोच रहा है...",
        liveResults: "लाइव खेत के परिणाम",
        uploadPrompt: "पौधों के स्वास्थ्य, कीड़े और फसल की मात्रा देखने के लिए एक फोटो अपलोड करें।",
